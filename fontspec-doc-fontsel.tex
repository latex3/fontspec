...
Swash font shapes in a family can be set up in two different ways, depending on your needs and the available font support.

The first approach is to have `swash' as a sibling to `italic', where using \cs{\textsw} will switch shapes wholesale into the desired selection:
\begin{Verbatim}
  \setmainfont{...}[
        SwashFont = {...} ,
    BoldSwashFont = {...} ,
