%%^^A%%  fontspec-doc-xetex.tex  -  part of FONTSPEC <github.com/wspr/fontspec>
...
that provided (only) by \MacOSX\ itself.
...
The third is \opt{Graphite}, which is an alternative to OpenType with particular features for less-common languages.
