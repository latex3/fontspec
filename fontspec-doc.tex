...
The synonym \cs{FontIfExistsTF} is provided for `document authors'.

E.g.:
\begin{Verbatim}
  \FontIfExistsTF {cmr10}{T}{F}
  \FontIfExistsTF {Times~ New~ Roman}{T}{F}
  \FontIfExistsTF {texgyrepagella-regular.otf}{T}{F}
  \FontIfExistsTF {/Users/will/Library/Fonts/CODE2000.TTF}{T}{F}
\end{Verbatim}
\end{macro}
