...
\emph{While \pkg{fontspec} is providing the \texttt{TU} encoding, its interface should not be considered experimental; feedback welcome. Once \texttt{TU} is incorporated into the \LaTeXe\ kernel directly (later in 2016), it will be considered stable.}
